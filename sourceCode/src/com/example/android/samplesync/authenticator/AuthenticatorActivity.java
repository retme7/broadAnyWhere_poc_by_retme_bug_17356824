        ...
        b3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				  SharedPreferences sp = AuthenticatorActivity.this.getApplicationContext().getSharedPreferences("poc",AuthenticatorActivity.this.MODE_WORLD_READABLE);
				  SharedPreferences.Editor edit = sp.edit();
				  edit.putInt("poc_type", 2);
				  edit.commit();
